                ...
                <Card border="warning" className="mt-3 mb-3" style={{ borderRadius: "10p", boxShadow: "5px 5px 10px rgba(0,0,0,0.5)" }}>
                    <Card.Header style={{ backgroundColor: "#d0c311", color: "#FFFFFF" }}>
                        ...
                        {post.created_by._id === currentUser._id ?
                            <Button className='edit-btn' size="sm" variant="primary" style={{ float: "right", backgroundColor: "#4c68a5", color: "#FFFFFF" }} onClick={() => history.push(`/edit/${post._id}`)} ><strong>Edit My Post</strong></Button>
                            : null}
                    </Card.Header>
