        ...
        <Wrapper>
            ...
            <div className="row justify-content-md-center">
                <div className="col-lg-8 text-center">
                    <p style={{color: "#5a5a5a"}}>Our aim is to create an accessible platform to unify local communities around resource sharing. 
                    ...
                    tech platform taking a cut for profit.</p>
                </div>
            </div>
            <div className="row justify-content-md-center">
            <div className="col-lg-8 text-center">
