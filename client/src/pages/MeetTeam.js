        ...
        <Wrapper>
            ...
            <div className="row justify-content-md-center text-center">
                ...
                <div className="col-lg-3">
                    ...
                    <p style={{ color: "#5a5a5a" }}>Talented Junior Software Engineer offering 4 years of transferable skills and experience working on Agile Development and top notch abilities in organizing workflows, solving complex problems and making accurate decisions based on sound judgment and analytical strengths. Fluent both in English and Spanish.</p>
                </div>
                <div className="col-lg-3">
