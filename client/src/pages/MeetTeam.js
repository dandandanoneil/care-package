        ...
        <Wrapper>
            ...
            <div className="row justify-content-md-center text-center">
                <div className="col-lg-3">
                    ...
                    <a style={{color: "#021247"}} href="https://github.com/dandandanoneil">GitHub Profile</a>
                ...
                <div className="col-lg-3">
                    ...
                    <a style={{color: "#021247"}} href="https://github.com/canahuate16">GitHub Profile</a>
                ...
                <div className="col-lg-3">
                    ...
                    <a style={{color: "#021247"}} ref="https://github.com/skylerdakota">GitHub Profile</a>
