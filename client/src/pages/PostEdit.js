        ...
        <Wrapper>
            <Card border="warning" className="mt-3 mb-3">
                ...
                <Form className="p-3" style={{ backgroundColor: "#fafafa" }}>
                    ...
                    <Button size="sm" className="mt-1 ml-1 edit-btn" variant="warning" style={{ float: "right", backgroundColor: "#d0c311" }} onClick={handleEditSubmit}>Update</Button>
                    <Button size="sm" className="mt-1 ml-1 edit-btn" variant="primary" style={{ float: "right", backgroundColor: "#4c68a5" }} onClick={handleDiscardChanges}>Discard Changes</Button>
                    <Button size="sm" className="mt-1 ml-1 edit-btn" variant="danger" style={{ float: "right", backgroundColor: "#d05d11" }} onClick={handleDeletePost}>Delete</Button>
                </Form>
            </Card>
