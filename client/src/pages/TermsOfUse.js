            ...
            <div className="row justify-content-md-center">
                <div className="col-lg-11">
                    ...
                    <Card style={{ border: "double", borderColor: "#ca885b", display: 'flex', justifyContent: 'center' }}>
                        <Card.Body>
                            <Card.Text>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> Last updated February 9, 2021</p>
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> AGREEMENT TO TERMS</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and [business entity name] (“we,” “us” or “our”), concerning your access to and use of the [website name.com] website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”).
                                ...
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> The Site is intended for users who are at least 18 years old. Persons under the age of 18 are not permitted to register for the Site.</p>
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> INTELLECTUAL PROPERTY RIGHTS</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> Unless otherwise indicated, the Site is our proprietary property and all source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics on the Site (collectively, the “Content”) and the trademarks, service marks, and logos contained therein (the “Marks”) are owned or controlled by us or licensed to us, and are protected by copyright and trademark laws and various other intellectual property rights and unfair competition laws of the United States, foreign jurisdictions, and international conventions.
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> USER REPRESENTATIONS</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> By using the Site, you represent and warrant that:
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> USER REGISTRATION</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> You may be required to register with the Site. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.</p>
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> PROHIBITED ACTIVITIES</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> You may not access or use the Site for any purpose other than that for which we make the Site available. The Site may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.
                                ...
                                [other]</p>
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> USER GENERATED CONTRIBUTIONS</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> The Site may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other functionality, and may provide you with the opportunity to create, submit, post, display, transmit, perform, publish, distribute, or broadcast content and materials to us or on the Site, including but not limited to text, writings, video, audio, photographs, graphics, comments, suggestions, or personal information or other material (collectively, “Contributions”).
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> CONTRIBUTION LICENSE</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> By posting your Contributions to any part of the Site [or making Contributions accessible to the Site by linking your account from the Site to any of your social networking accounts], you automatically grant, and you represent and warrant that you have the right to grant, to us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and license to host, use, copy, reproduce, disclose, sell, resell, publish, broadcast, retitle, archive, store, cache, publicly perform, publicly display, reformat, translate, transmit, excerpt (in whole or in part), and distribute such Contributions (including, without limitation, your image and voice) for any purpose, commercial, advertising, or otherwise, and to prepare derivative works of, or incorporate into other works, such Contributions, and grant and authorize sublicenses of the foregoing. The use and distribution may occur in any media formats and through any media channels.
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> GUIDELINES FOR REVIEWS</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> We may provide you areas on the Site to leave reviews or ratings. When posting a review, you must comply with the following criteria:
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> MOBILE APPLICATION LICENSE</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> Use License
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> SUBMISSIONS</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> You acknowledge and agree that any questions, comments, suggestions, ideas, feedback, or other information regarding the Site (“Submissions”) provided by you to us are non-confidential and shall become our sole property. We shall own exclusive rights, including all intellectual property rights, and shall be entitled to the unrestricted use and dissemination of these Submissions for any lawful purpose, commercial or otherwise, without acknowledgment or compensation to you.

                                You hereby waive all moral rights to any such Submissions, and you hereby warrant that any such Submissions are original with you or that you have the right to submit such Submissions. You agree there shall be no recourse against us for any alleged or actual infringement or misappropriation of any proprietary right in your Submissions.</p>
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> THIRD-PARTY WEBSITES AND CONTENT</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> The Site may contain (or you may be sent via the Site) links to other websites (“Third-Party Websites”) as well as articles, photographs, text, graphics, pictures, designs, music, sound, video, information, applications, software, and other content or items belonging to or originating from third parties (“Third-Party Content”).
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> ADVERTISERS</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> We allow advertisers to display their advertisements and other information in certain areas of the Site, such as sidebar advertisements or banner advertisements. If you are an advertiser, you shall take full responsibility for any advertisements you place on the Site and any services provided on the Site or products sold through those advertisements.
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> SITE MANAGEMENT</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> We reserve the right, but not the obligation, to:
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> Notifications
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> MODIFICATIONS AND INTERRUPTIONS</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> We reserve the right to change, modify, or remove the contents of the Site at any time or for any reason at our sole discretion without notice. However, we have no obligation to update any information on our Site. We also reserve the right to modify or discontinue all or part of the Site without notice at any time.
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> CORRECTIONS</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> There may be information on the Site that contains typographical errors, inaccuracies, or omissions that may relate to the Site, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Site at any time, without prior notice.</p>
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> DISCLAIMER</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SITE AND OUR SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE SITE AND YOUR USE THEREOF, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE SITE’S CONTENT OR THE CONTENT OF ANY WEBSITES LINKED TO THE SITE AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT AND MATERIALS, (2) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SITE, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN, (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE SITE, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SITE BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SITE. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SITE, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND WE WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES.
                                ...
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and all of our respective officers, agents, partners, and employees, from and against any loss, damage, liability, claim, or demand, including reasonable attorneys’ fees and expenses, made by any third party due to or arising out of: (1) [your Contributions]; (2) use of the Site; (3) breach of these Terms and Conditions; (4) any breach of your representations and warranties set forth in these Terms and Conditions; (5) your violation of the rights of a third party, including but not limited to intellectual property rights; or (6) any overt harmful act toward any other user of the Site with whom you connected via the Site.

                                Notwithstanding the foregoing, we reserve the right, at your expense, to assume the exclusive defense and control of any matter for which you are required to indemnify us, and you agree to cooperate, at your expense, with our defense of such claims. We will use reasonable efforts to notify you of any such claim, action, or proceeding which is subject to this indemnification upon becoming aware of it.</p>
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> USER DATA</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> We will maintain certain data that you transmit to the Site for the purpose of managing the Site, as well as data relating to your use of the Site. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Site.
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> Visiting the Site, sending us emails, and completing online forms constitute electronic communications. You consent to receive electronic communications, and you agree that all agreements, notices, disclosures, and other communications we provide to you electronically, via email and on the Site, satisfy any legal requirement that such communication be in writing.
                                ...
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> CALIFORNIA USERS AND RESIDENTS</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>
                                <h6 style={{ color: "#5a5a5a", fontWeight: "bold", display: 'flex', justifyContent: 'center' }}> MISCELLANEOUS</h6>
                                <p style={{ color: "#5a5a5a", fontWeight: "bold" }}> These Terms and Conditions and any policies or operating rules posted by us on the Site constitute the entire agreement and understanding between you and us. Our failure to exercise or enforce any right or provision of these Terms and Conditions shall not operate as a waiver of such right or provision.
