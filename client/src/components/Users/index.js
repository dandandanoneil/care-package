...
import marcionImage from "./images/marcion.jpg";
import jenniferImage from "./images/jennifer.jpg";
import yeasminImage from "./images/yeasmin.jpg";

function Users() {
    return (
    <div className="row justify-content-md-center text-center">
    <div className="col-lg-3">
        <Image src={jenniferImage} fluid roundedCircle alt="User Story Jennifer" />
    ...
    <div className="col-lg-3">
        <Image src={marcionImage} fluid roundedCircle alt="User Story Marcion" />
    ...
    <div className="col-lg-3">
        <Image src={yeasminImage} fluid roundedCircle alt="User Story Yeasmin" />
